...
.config('spark.executor.instances', '24').config('spark.executor.cores','2').config('spark.driver.maxResultSize', '1g') \
...
file_path = 'gs://vp-bucket-1/notebooks_jupyter_notebooks_jupyter_vehicles.csv'
...
performance_dict = {
    'Cores & Instances': '2 cores & 24 instances',
...
def reg_metrics(model, train_data, test_data, algo):
    ...
    1. RÂ² or Coefficient of Determination.
    2. Adjusted RÂ²
    ...
    #1 & 2 Coefficient of Determination (RÂ² & Adjusted RÂ²)
    print("\n\t--- Coefficient of Determination (RÂ² & Adjusted RÂ²) ---")
...
# Save to csv
output_path = "gs://vp-bucket-1/2-cores-24-instances.csv"
